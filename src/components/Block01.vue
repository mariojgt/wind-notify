    ...
    <div class="hero min-h-screen bg-base-200">
        <div class="hero-content w-full text-center">
            <div class="w-full">
                ...
                <p class="py-6">
                    Wind-Notify provide a simple and easy way to display tailwind and
                    ...
                    all you need is to import and call ONE method.
                </p>
                <div class="badge">
              ...
              " style="background-size: 5px 5px">
                ...
                <div class="w-full p-10">
                    ...
                    <div class="mockup-code">
                        ...
                        <pre data-prefix="$"
                            class="text-gray-500"><code>// message = you notification message</code></pre>
                        <pre data-prefix="$"
                        ...
                        <pre data-prefix="$"
                            class="text-gray-500"><code>// position = top, bottom, right, left</code></pre>
                        <pre data-prefix="$"
                        ...
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <div class="mockup-code text-left">
                                    <pre data-prefix="1" class="text-success" ><code>const plugin = require('tailwindcss/plugin')</code> </pre>
                                    ...
                                    <pre data-prefix="6" class="text-warning" ><code>        // Don't purge the classes you need</code> </pre>
                                    <pre data-prefix="9" class="text-warning" ><code>        "@mariojgt/wind-notify/packages/toasts/messages.js"</code> </pre>
